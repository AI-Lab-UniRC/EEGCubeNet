...
- EEG Lab is recommended to process the following .mat files 
- 
The flowchart of EEG volumetric data processing is folloiwng:
![EEGProcessing](https://github.com/M-Suffian/EEGCubeNet/blob/main/EGG%20Video%20PreProcessing/eegvideoprocessing.PNG)
